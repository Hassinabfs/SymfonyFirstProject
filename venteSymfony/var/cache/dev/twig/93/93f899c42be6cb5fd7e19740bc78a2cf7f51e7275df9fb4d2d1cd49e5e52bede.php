...
class __TwigTemplate_ca62a540e76a39dcf92f378a8929313626510aee3a9ceed608e54f2235de9385 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 4
        echo "Merci de remplir vos Informations
...
\t";
        // line 10
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 10, $this->source); })()), "email", [], "any", false, false, false, 10), 'row', ["label" => "Adresse e-mail", "attr" => ["placeholder" => "e-mail"]]);
        echo "
\t";
        // line 11
...
";
    ...
    {
        return array (  101 => 20,  90 => 12,  86 => 11,  82 => 10,  78 => 9,  73 => 7,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% block body %}
Merci de remplir vos Informations


{{ form_start(form) }}

{{ form_row(form.username, {'label': 'Nom d\\'utilisateur','attr':{'placeholder': \"Username\"}}) }}
\t{{ form_row(form.email, {'label': 'Adresse e-mail','attr':{'placeholder': \"e-mail\"}}) }}
\t{{ form_row(form.password, {'label': 'Mot de passe','attr':{'placeholder': \"Password\"}}) }}
\t{{ form_row(form.confirm_password, {'label': 'Confirmation du mot de passe ','attr':{'placeholder': \"confirm password\"}}) }}
...
{% endblock %}
", "security/inscription.html.twig", "/Users/su6i/Amir/gitProjects/myGitProjects/Master-IPS-2019/temp/Hassina/SymfonyFirstProject/venteSymfony/templates/security/inscription.html.twig");
    }
}
